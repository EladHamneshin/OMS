...
const OrderDetails: React.FC<OrderDetailsProps> = ({ selectedOrder }) => {
    ...
    const handleSave = async () => {
        try {
            ...
            // Assuming `editedOrder` is an object like { status: 'someStatus', otherField: 'otherValue' }
            const statusKey = 'status';
            const statusValue = editedOrder[statusKey];
            const updatedOrder = await updateOrder(selectedOrder._id, { [statusKey]: statusValue });
